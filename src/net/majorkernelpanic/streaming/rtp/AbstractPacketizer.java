...
abstract public class AbstractPacketizer {
	...
	public boolean isRunFlag = false; //是否send()
	public RandomAccessFile raf = null;
	public int flag = 0;//录像标识位
	public int iFrameFlag = 0,dataFlag = 0;//iFrameFlag 第一从I帧开始发送 dataFlag数据帧标识位
...
//	}
	...
	//写文件头
	public abstract void recordFile(String filePath);

	/** Starts the packetizer.H264Packetizer */
	...
	/** Stops the packetizer. */
	//public abstract void stopInputStream();
