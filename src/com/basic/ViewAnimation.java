...
public class ViewAnimation {
	...
	public static void ViewChange(int type, View out, View in, long durationMillis, long delayMillis) {
		ViewAnimation va = new ViewAnimation();
		va.slideOut(out, durationMillis, delayMillis);
		va.slideIn(in, durationMillis, delayMillis);
		va = null;
	}
