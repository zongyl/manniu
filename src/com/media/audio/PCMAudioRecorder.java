...
//	private static final int audioEncoding = AudioFormat.ENCODING_PCM_16BIT;
	...
	public PCMAudioRecorder(IAudioData user,int bit,int mono) {
		...
		int bufferSize = AudioRecord.getMinBufferSize(Constants.frequency, AudioFormat.CHANNEL_CONFIGURATION_MONO, bit);

		if(bufferSize > 0){
			_tempBuffer = new byte[bufferSize];
			_recorder = new AudioRecord(MediaRecorder.AudioSource.MIC, Constants.frequency, 
					AudioFormat.CHANNEL_CONFIGURATION_MONO, bit, bufferSize);
		}
	}
