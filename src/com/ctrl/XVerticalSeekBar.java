...
/**
 * Created by IntelliJ IDEA. User: li_jianhua Date: 2014-9-10 下午7:40:46
 * To change this template use File | Settings | File Templates.
 * Description： 自定义--垂直 seekBar
 */
public class XVerticalSeekBar extends AbsSeekBar{
	private Drawable mThumb;  
	  
    public interface OnSeekBarChangeListener {  
        void onProgressChanged(XVerticalSeekBar VerticalSeekBar, int progress, boolean fromUser);  
  
        void onStartTrackingTouch(XVerticalSeekBar VerticalSeekBar);  
  
        void onStopTrackingTouch(XVerticalSeekBar VerticalSeekBar);  
    }  
