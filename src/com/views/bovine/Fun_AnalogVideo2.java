 ...
 * Description： 牛眼 TAB（留底）
 */
@SuppressLint("NewApi")
public class Fun_AnalogVideo2 extends XViewBasic implements OnClickListener, OnTaskListener,OnTouchListener{  
	private String TAG = Fun_AnalogVideo2.class.getSimpleName();
	public static Fun_AnalogVideo2 instance = null;
	...
	public static int resolution = 0; //0, 1, 2, 3
...
//	public int[] _framerate = {30,20,15};
	...
	//public Dlg_Wait _dlgWait2 = null;
	public H264Stream h = null;
	//分享状态
	private boolean isshare = false;
	
    public Fun_AnalogVideo2(Activity activity, int viewId, String title) {
		super(activity, viewId, title);
		context = activity;
		instance = this;
//		SharedPreferences _preferences = APP.GetMainActivity().getSharedPreferences(NewLogin.SAVEFILE, APP.GetMainActivity().MODE_PRIVATE);
//        userName = _preferences.getString("user0", "");
//        userId = _preferences.getString("sid", "");
...
//			break;
	...
	public void isDeviceOpen(){
		...
		.setPositiveButton(context.getString(R.string.confirm), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				if(viewPager.getCurrentItem() == 0)
					Fun_AnalogVideo2.instance.onClick(textView3);
			}
		}).show();
	}
	...
	private void cancelShare(){
		//TODO 待完善
		APP.ShowToast(context.getString(R.string.analog_video_cancel_share));
		RequestParams params = new RequestParams();
		params.put("deviceId", _devSid);
...
//				});
            	...
            	APP.ShowWaitDlg(Fun_AnalogVideo2.this, R.string.openning_stream, 0, 0);
                break; 
            case 1:
        		...
        		if(isDevice){
        			...
        			_btnSub.setText(ACT.getResources().getString(R.string.analog_video_update));
        		}else{
        			_QRcodeRow.setVisibility(View.GONE);
        			_devTite.setVisibility(View.GONE);
        			//_btnSub.setText("开  通");
        			_btnSub.setText(ACT.getResources().getString(R.string.analog_video_open));
        		}
        		initSetting();
			...
			if (Integer.parseInt(map.get("code").toString()) == 200) {
				...
				try {
					msg = json.getString("msg");
						...
						isDevice = true;
						textView3.setText(APP.GetMainActivity().getText(R.string.analog_video_update).toString());
						...
						isDevice = false;
						textView3.setText(APP.GetMainActivity().getText(R.string.analog_video_open).toString());
						Log.d(TAG, "未开通!");
					}
				} catch (JSONException e) {
					e.printStackTrace();
