...
/**
 * Created by IntelliJ IDEA. User: li_jianhua Date: 2014-7-9 下午4:25:04
 * To change this template use File | Settings | File Templates.
 * Description：
 * 仿Launcher中的WorkSapce，可以左右、上下滑动切换屏幕的
 */
public class ScrollLayout extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		/**
		 * wrap_content 浼犺繘鍘荤殑鏄疉T_MOST 鍥哄畾鏁帮拷?鎴杅ill_parent 浼犲叆鐨勬ā寮忔槸EXACTLY
		 */
